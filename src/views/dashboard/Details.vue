          ...
          <div class="row">
            <div class="col">
              <div class="product-logo-div">
                <img class="product-logo" :src="'/static/actions/withdraw-black.png'" alt=""/>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col">
              <p class="pdt-name">{{ bftRewards }}</p>
            </div>
          </div>
          <div class="row">
            <div class="col">
      ...
      <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 col-xs-12 text-center">
        <div class="product-div">
          <div class="row">
            <div class="col">
              <div class="product-logo-div">
                <img class="product-logo" :src="'/static/actions/deposit-black.png'" alt=""/>
              </div>
            </div>
          </div>
   ...
   <!--               modal                   -->
    ...
    <div class="modal fade" id="harvestModal">
      <div class="modal-dialog">
        <div class="modal-content text-center">
          <div class="modal-body">
            <p class="welcome-tit">{{ $t("modal.tit3")}} {{ this.$route.params.tx_id }} Pool BFT</p>
            <div class="row">
              <div class="col">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">{{ $t("common.cancel") }}</button>
              </div>
