...
<!--    </div>-->
    <div class="row">
      <input type="submit" v-show="productIndex >= 0" class="btn btn-info btn-select" :value="$t('dashboard.product.select')"
             id="selectBtn"
             @click="select">

      <input type="submit" v-show="productIndex < 0" class="btn btn-info btn-select" disabled="disabled" :value="$t('dashboard.product.comingSoon')">
    </div>
